...
from hacks.cpm import pc
from hacks.cpm.buildsystem import BuildSystem
from hacks.cpm.utils import relpath
    ...
    def _mkruntime(self,prefix,output_dir):
        ...
        for i in self.recipe.dist_files_list():
            ...
            if os.path.exists(path):
                ...
                assert not path.endswith(".so") and not path.endswith(".dll"),'''
                missing %s in runtime package'''%path
    ...
    def _mkdevel(self,prefix,output_dir):
        ...
        for i in self.recipe.devel_files_list():
            ...
            if os.path.exists(path):
                ...
                assert False, "devel request %s not exits"%i
